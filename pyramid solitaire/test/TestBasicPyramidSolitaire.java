...
/**
 * Tests for the public methods of {@link BasicPyramidSolitaire}s.
 */
public class TestBasicPyramidSolitaire {

  /**
   * objects to test methods on.
   */
  BasicPyramidSolitaire unstartedGame;
  BasicPyramidSolitaire startedDefaultGame;
  BasicPyramidSolitaire startedCustomGame1;
  BasicPyramidSolitaire startedCustomGame2;
  BasicPyramidSolitaire startedCustomGameDraw;
  BasicPyramidSolitaire gameDraw2;
  BasicPyramidSolitaire gameWin;
  BasicPyramidSolitaire gameLose;
  BasicPyramidSolitaire unstartedGame2;
  BasicPyramidSolitaire startedDefaultGame2;
  BasicPyramidSolitaire defaultGameChangeDrawSize;
  BasicPyramidSolitaire defaultGameChangeNumRows;
  BasicPyramidSolitaire defaultShuffled;
  BasicPyramidSolitaire defaultGameDiscardDraw;
  BasicPyramidSolitaire defaultGameChangedStock;
  BasicPyramidSolitaire gameLostNoDraw;
  ...
  public void setup() {
    ...
    unstartedGame = new BasicPyramidSolitaire();
    ...
    startedCustomGame1 = new BasicPyramidSolitaire(deckWithKing, 3, 0);
    startedCustomGameDraw = new BasicPyramidSolitaire(deck1, 3, 2);
    gameDraw2 = new BasicPyramidSolitaire(deckWithStock, 3, 2);
    startedCustomGame2 = new BasicPyramidSolitaire(deckWithCardRemoved, 3, 2);
    gameWin = new BasicPyramidSolitaire(deckWin, 3, 3);
    gameLose = new BasicPyramidSolitaire(deckLose, 3, 3);
    gameLostNoDraw = new BasicPyramidSolitaire(deckLose, 3, 0);
    unstartedGame2 = new BasicPyramidSolitaire();
    ...
    defaultGameChangedStock = new BasicPyramidSolitaire(deckWithStockChanged, 7, 2);
   ...
   */
  private boolean isShuffled(BasicPyramidSolitaire model) {
   ...
   * @return the game
   */
  BasicPyramidSolitaire makeGame(boolean shuffle, int rows, int draw) {
